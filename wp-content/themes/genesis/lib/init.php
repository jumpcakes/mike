...
// Add CTA Shortcode
function mikediamond_cta_shortcode() {
	
	$cta = "";
	$cta .= '<div class="cta-shortcode" role="alert">';
	$cta .= '<div class="row">';
	
	$cta .= '<h2>Need Service Now?</h2>';
	$cta .= '<p>We\'re open 24/7 day and night to serve you when you need it most.</p>';
	$cta .= '<a href="http://mikediamondservices.com/appointments/" target="_blank" class="btn btn-info cta-quote-btn"><i class="icon-bookmark"></i> Schedule Service</a>';
	$cta .= '<span id="cta-phone"><a href="tel:+18004466453"><i class="icon-phone"></i> <span class="ajax-num">1-800-446-6453</span></a></span>';
	//$cta .= '</div>';
	$cta .= '</div>';
	$cta .= '</div>';
	return $cta;
...
add_shortcode( 'cta', 'mikediamond_cta_shortcode' );
