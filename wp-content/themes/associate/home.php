...
function associate_home_loop_helper() {
	...
	if ( is_active_sidebar( 'featured' ) ) {
		echo '<a href="http://mikediamondservices.com/location/"><img class="mobileimage" src="http://mikediamondservices.com/wp-content/themes/associate/images/mobilehome.jpg"></a>';
